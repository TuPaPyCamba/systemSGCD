            ...
            <tr class="edit-form">
                <td colspan="6">
                    <form action="gestionMedico.jsp" method="post">
                        ...
                        <label>Usuario: </label><input type="text" name="usuario" value="<%= medico.getUsuario()%>">
                        <label>Contraseña: </label><input type="password" name="contasena" value="<%= medico.getContrasena()%>">
                        <label>Nombre: </label><input type="text" name="nombre" value="<%= medico.getNombre()%>">
                        <label>Apellidos: </label><input type="text" name="apellidos" value="<%= medico.getApellidos()%>">
