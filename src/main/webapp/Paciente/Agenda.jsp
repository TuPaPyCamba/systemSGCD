            ...
            <div class="g-container">
                ...
                <%
                    ...
                    if (fechaParam != null) {
                        ...
                        List<Cita> citas = citaDAO.obtenerTodasCitasPorPaciente(idSesion, fecha);
                ...
                <% } %>
                <% } else { %>
                <p class="mt-4 text-red-500">Por favor, seleccione una fecha para buscar.</p>
                <% } %>
                ...
                <%
                    ...
                    if (fechaParamr != null) {
                        ...
                        List<Consulta> consultas = consultaDAO.obtenerTodasConsultasParaPaciente(idSesion, fechaconsulta);
                ...
                <% } else { %>
                <p class="mt-4 text-red-500">No se encontraron consultas para el paciente y la fecha seleccionados.</p>
                <% } %>
                <% } else { %>
                <p class="mt-4 text-red-500">Por favor, seleccione una fecha para buscar.</p>
                <% } %>
